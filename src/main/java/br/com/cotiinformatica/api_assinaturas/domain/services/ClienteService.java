...
import br.com.cotiinformatica.api_assinaturas.domain.exceptions.RegistroNaoEncontrato;
...
public class ClienteService {
    ...
    public ClienteResponse alterarCliente(Integer id, ClienteRequest request) throws Exception{
        ...
        if(registro.isEmpty())
            throw new RegistroNaoEncontrato("Cliente não encontrato para o id informado: " + id);
